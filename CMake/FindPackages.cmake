...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Boost 1.41.0 COMPONENTS unit_test_framework system thread filesystem program_options thread serialization)
  if((NOT Boost_FOUND) AND (NOT BOOST_FOUND))
    pkg_check_modules(Boost Boost>=1.41.0)
  endif()
  if((NOT Boost_FOUND) AND (NOT BOOST_FOUND))
    message(FATAL_ERROR "Could not find Boost COMPONENTS unit_test_framework system thread filesystem program_options thread serialization")
  endif()
else()
  find_package(Boost 1.41.0  REQUIRED unit_test_framework system thread filesystem program_options thread serialization)
endif()
...
if(Boost_name)
  list(APPEND FIND_PACKAGES_DEFINES ASYNCIO_USE_BOOST)
...
if(AIO_name)
  list(APPEND FIND_PACKAGES_DEFINES ASYNCIO_USE_AIO)
  set(FIND_PACKAGES_FOUND "${FIND_PACKAGES_FOUND} AIO")
  link_directories(${${AIO_name}_LIBRARY_DIRS})
  if(NOT "${${AIO_name}_INCLUDE_DIRS}" MATCHES "-NOTFOUND")
    include_directories(${${AIO_name}_INCLUDE_DIRS})
  endif()
endif()

set(ASYNCIO_BUILD_DEBS autoconf;automake;cmake;doxygen;git;git-review;pkg-config;subversion)

set(ASYNCIO_DEPENDS Boost;AIO)
